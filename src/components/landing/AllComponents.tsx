  ...
  return (
    <footer className="footer-v2">
      <div className="footer-grid">
        <div className="footer-brand">
          ...
          <p className="footer-tagline">
            Ingeniería estructural de precisión.<br />Diseño, cálculo y BIM para obras que no fallan.
          </p>
        </div>
        ...
        <div className="footer-col">
          ...
          <ul className="footer-contact">
            ...
            <li>
              ...
              <a href="https://wa.me/573163195050" target="_blank" rel="noopener noreferrer">+57 316 319 5050</a>
            </li>
            <li>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
              <a href="mailto:contacto@estructurarte.co">contacto@estructurarte.co</a>
            </li>
          </ul>
        </div>

        <div className="footer-col footer-allied">
          <h4>Diseño integral</h4>
          <p className="footer-allied-text">
            En alianza con Duber Parra Diseño Integral
          </p>
          <a
            href="https://wa.me/573163195050"
            target="_blank"
            rel="noopener noreferrer"
            className="footer-deko"
            aria-label="Contactar a Duber Parra por WhatsApp"
          >
            <img
              src="https://res.cloudinary.com/dm75skole/image/upload/v1777624835/Logo_Duber_zhagkk.png"
              alt="Duber Parra Diseño Integral"
              loading="lazy"
              decoding="async"
            />
          </a>
      ...
      <div className="footer-bottom">
        <div className="fc">© {year} Estructurarte · NSR-10 · Colombia</div>
        <div className="footer-credit">
          Diseño y desarrollo en alianza con <span>Duber Parra</span>
        </div>
      </div>
    </footer>
  );
